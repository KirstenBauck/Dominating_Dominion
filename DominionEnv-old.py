...
class DominionEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        # Supply pile counts (simplified to categories)
        supply_counts = {}
        ...
        # Create a more compact observation vector with the most important features
        obs = []
        ...
        # Hand counts for each card (17 values) - most important for decision making
        for card in self.cards:
        ...
        # Played area counts (17 values) - important for tracking action usage
        for card in self.cards:
